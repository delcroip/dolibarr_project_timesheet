...
//define('getConf('TIMESHEET_DAY_MAX_DURATION')', '12');
header('Content-Type: text/javascript');
echo 'var day_max_hours = '.null2zero(getConf('TIMESHEET_DAY_MAX_DURATION')).";\n";
echo 'var day_hours = '.null2zero(getConf('TIMESHEET_DAY_DURATION',8)).";\n";
echo 'var time_type = "'.getConf('TIMESHEET_TIME_TYPE','hours')."\";\n";
echo 'var hide_zero = '.null2zero(getConf('TIMESHEET_HIDE_ZEROS')).";\n";
